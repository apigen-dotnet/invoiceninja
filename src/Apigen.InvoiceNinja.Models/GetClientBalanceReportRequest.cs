...
/// <summary>
/// GetClientBalanceReportRequest from OpenAPI schema.
/// Schema path: #/components/schemas/GetClientBalanceReportRequest
/// </summary>
public class GetClientBalanceReportRequest
{
  /// <summary>
