...
public class Company
{
  ...
  /// <summary>
  /// Flag indicating whether to convert rates to the client currency
  /// </summary>
  [System.Text.Json.Serialization.JsonPropertyName("convert_rate_to_client")]
  public bool? ConvertRateToClient { get; set; }

  /// <summary>
  /// Authentication token for e-invoicing services
  /// </summary>
  [System.Text.Json.Serialization.JsonPropertyName("e_invoicing_token")]
  public string? EInvoicingToken { get; set; }

  /// <summary>
  /// Flag indicating whether the shop API is enabled
  /// </summary>
  [System.Text.Json.Serialization.JsonPropertyName("enable_shop_api")]
  public bool? EnableShopApi { get; set; }

  /// <summary>
  /// Flag indicating whether markdown formatting is enabled in emails
  /// </summary>
  [System.Text.Json.Serialization.JsonPropertyName("markdown_email_enabled")]
  public bool? MarkdownEmailEnabled { get; set; }

  /// <summary>
  /// Flag indicating whether to use comma as decimal separator instead of period
  /// </summary>
  [System.Text.Json.Serialization.JsonPropertyName("use_comma_as_decimal_place")]
