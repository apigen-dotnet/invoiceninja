...
/// <summary>
/// GetClientContactReportRequest from OpenAPI schema.
/// Schema path: #/components/schemas/GetClientContactReportRequest
/// </summary>
public class GetClientContactReportRequest
{
  /// <summary>
