...
public partial interface IGroupSettingsClient
{
  ...
  /// </summary>
  Task<ApiResponse<GroupSetting>> EditAsync(string id, EditGroupSettingRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Performs bulk actions on an array of group_settings
  /// Operation: POST /api/v1/group_settings/bulk
  /// </summary>
  Task BulkAsync(List<int> body, BulkGroupSettingsRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Uploads a document to a group setting
  /// Operation: POST /api/v1/group_settings/{id}/upload
  /// </summary>
  Task<ApiResponse<Invoice>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadGroupSettingRequest uploadGroupSettingRequest, UploadGroupSettingRequest? request = null, CancellationToken cancellationToken = default);
