...
public partial class CreditsClient : ICreditsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Invoice>> EditAsync(string id, EditCreditRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task BulkAsync(List<string> body, BulkCreditsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Credit>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadCreditsRequest uploadCreditsRequest, UploadCreditsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
