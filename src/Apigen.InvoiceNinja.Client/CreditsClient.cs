...
public partial class CreditsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Credit[]>> ListAsync(GetCreditsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Credit>> CreateAsync(Apigen.InvoiceNinja.Models.CreditRequest creditRequest, StoreCreditRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "credits".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<Credit>> GetAsync(string id, ShowCreditRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task DeleteAsync(string id, DeleteCreditRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Invoice>> EditCreditAsync(string id, EditCreditRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Credit>> GetCreditsCreateAsync(GetCreditsCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task BulkAsync(BulkCreditsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Credit>> UploadCreditsAsync(string id, Apigen.InvoiceNinja.Models.UploadCreditsRequest uploadCreditsRequest, UploadCreditsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
