...
public partial class ClientGatewayTokensClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<ClientGatewayToken[]>> ListAsync(GetClientGatewayTokensRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<ClientGatewayToken>> CreateAsync(StoreClientGatewayTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "client_gateway_tokens".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<ClientGatewayToken>> GetAsync(string id, ShowClientGatewayTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<ClientGatewayToken>> UpdateAsync(string id, UpdateClientGatewayTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeleteAsync(string id, DeleteClientGatewayTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<ClientGatewayToken>> EditClientGatewayTokenAsync(string id, EditClientGatewayTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<ClientGatewayToken>> GetClientGatewayTokensCreateAsync(GetClientGatewayTokensCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
