...
/// </summary>
public partial class ClientGatewayTokensClient : IClientGatewayTokensClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<ClientGatewayToken>> EditAsync(string id, EditClientGatewayTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
