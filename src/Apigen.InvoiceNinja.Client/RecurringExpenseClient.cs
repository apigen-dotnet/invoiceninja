...
/// </summary>
public partial class RecurringExpenseClient : IRecurringExpenseClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringExpense>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadRecurringExpenseRequest uploadRecurringExpenseRequest, UploadRecurringExpenseRequest? request = null, CancellationToken cancellationToken = default)
  {
