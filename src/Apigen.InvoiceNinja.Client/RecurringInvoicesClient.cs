...
/// </summary>
public partial class RecurringInvoicesClient : IRecurringInvoicesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringInvoice[]>> GetAsync(GetRecurringInvoicesRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringInvoice>> StoreAsync(Apigen.InvoiceNinja.Models.RecurringInvoiceRequest recurringInvoiceRequest, StoreRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "recurring_invoices".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringInvoice>> ShowAsync(string id, ShowRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringInvoice>> EditAsync(string id, EditRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringInvoice>> ActionAsync(string id, string action, ActionRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<Stream> DownloadAsync(string invitationKey, DownloadRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringInvoice>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadRecurringInvoiceRequest uploadRecurringInvoiceRequest, UploadRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
