...
public partial interface IBankTransactionsClient
{
  ...
  /// </summary>
  Task<ApiResponse<BankTransaction>> EditAsync(string id, EditBankTransactionRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task BulkAsync(List<int> body, BulkBankTransactionsRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Match transactions
  /// Operation: POST /api/v1/bank_transactions/match
  /// </summary>
  Task MatchAsync(List<int> body, MatchBankTransactionsRequest? request = null, CancellationToken cancellationToken = default);
