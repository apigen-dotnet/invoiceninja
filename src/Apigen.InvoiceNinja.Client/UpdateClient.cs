...
public partial class UpdateClient
{
  ...
  /// </summary>
  public async Task SelfUpdateAsync(SelfUpdateRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task SelfUpdateCheckVersionAsync(CancellationToken cancellationToken = default)
  {
