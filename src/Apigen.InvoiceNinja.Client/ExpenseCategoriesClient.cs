...
/// </summary>
public partial class ExpenseCategoriesClient : IExpenseCategoriesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Webhook>> BulkExpenseCategorysAsync(List<int> body, BulkExpenseCategorysRequest? request = null, CancellationToken cancellationToken = default)
  {
