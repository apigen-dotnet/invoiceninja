...
public class PostmarkClient
{
  ...
  /// </summary>
  public async Task ConfirmApplePurchaseAsync(ConfirmApplePurchaseRequest? request = null)
  {
  ...
  /// </summary>
  public async Task ProcessAppleWebhookAsync(ProcessAppleWebhookRequest? request = null)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Credit>> PostmarkWebhookAsync(PostmarkWebhookRequest? request = null)
  {
