...
public partial class SubscriptionsClient : ISubscriptionsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Subscription>> EditAsync(string id, EditSubscriptionRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Subscription>> BulkAsync(List<int> body, BulkSubscriptionsRequest? request = null, CancellationToken cancellationToken = default)
  {
