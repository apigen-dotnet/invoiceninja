...
public partial interface IExpensesClient
{
  ...
  /// </summary>
  Task<ApiResponse<Expense>> EditAsync(string id, EditExpenseRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<ApiResponse<Expense>> BulkAsync(List<int> body, BulkExpensesRequest? request = null, CancellationToken cancellationToken = default);
