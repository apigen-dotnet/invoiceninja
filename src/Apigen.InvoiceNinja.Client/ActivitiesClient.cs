...
public partial class ActivitiesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Activity[]>> ListAsync(GetActivitiesRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Stream> GetAsync(string activityId, GetActivityHistoricalEntityPdfRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task PostActivitiesEntityAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task PostActivitiesNotesAsync(CancellationToken cancellationToken = default)
  {
