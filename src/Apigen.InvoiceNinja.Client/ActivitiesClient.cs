...
public partial class ActivitiesClient : IActivitiesClient
{
  ...
  /// </summary>
  public async Task<Stream> GetActivityHistoricalEntityPdfAsync(string activityId, GetActivityHistoricalEntityPdfRequest? request = null, CancellationToken cancellationToken = default)
  {
