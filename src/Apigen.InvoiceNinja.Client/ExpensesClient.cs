...
public partial class ExpensesClient : IExpensesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Expense>> EditAsync(string id, EditExpenseRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Expense>> BulkAsync(List<int> body, BulkExpensesRequest? request = null, CancellationToken cancellationToken = default)
  {
