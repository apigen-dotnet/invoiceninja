...
public partial class PaymentsClient : IPaymentsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> EditAsync(string id, EditPaymentRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> StoreRefundAsync(Apigen.InvoiceNinja.Models.PaymentRequest paymentRequest, StoreRefundRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> BulkAsync(List<int> body, BulkPaymentsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> ActionAsync(string id, string action, ActionPaymentRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadPaymentRequest uploadPaymentRequest, UploadPaymentRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
