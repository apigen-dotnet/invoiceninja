...
public partial class PaymentsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Payment[]>> ListAsync(GetPaymentsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> CreateAsync(Apigen.InvoiceNinja.Models.PaymentRequest paymentRequest, StorePaymentRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "payments".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> GetAsync(string id, ShowPaymentRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> UpdateAsync(string id, UpdatePaymentRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeleteAsync(string id, DeletePaymentRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> EditPaymentAsync(string id, EditPaymentRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> GetPaymentsCreateAsync(GetPaymentsCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> StoreRefundAsync(Apigen.InvoiceNinja.Models.PaymentRequest payment, StoreRefundRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> BulkAsync(BulkPaymentsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> GetAsync(string id, string action, ActionPaymentRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<ApiResponse<Payment>> UploadPaymentAsync(string id, Apigen.InvoiceNinja.Models.UploadPaymentRequest uploadPaymentRequest, UploadPaymentRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
