...
/// </summary>
public partial class StaticsClient : IStaticsClient
{
  ...
  /// </summary>
  public async Task GetAsync(GetStaticsRequest? request = null, CancellationToken cancellationToken = default)
  {
