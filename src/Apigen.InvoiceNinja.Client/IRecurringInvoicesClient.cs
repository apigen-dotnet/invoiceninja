...
public partial interface IRecurringInvoicesClient
{
  ...
  /// </summary>
  Task<ApiResponse<RecurringInvoice[]>> GetAsync(GetRecurringInvoicesRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Create recurring invoice
  /// Operation: POST /api/v1/recurring_invoices
  /// </summary>
  Task<ApiResponse<RecurringInvoice>> StoreAsync(Apigen.InvoiceNinja.Models.RecurringInvoiceRequest recurringInvoiceRequest, StoreRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Show recurring invoice
  /// Operation: GET /api/v1/recurring_invoices/{id}
  /// </summary>
  Task<ApiResponse<RecurringInvoice>> ShowAsync(string id, ShowRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<ApiResponse<RecurringInvoice>> EditAsync(string id, EditRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<ApiResponse<RecurringInvoice>> ActionAsync(string id, string action, ActionRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Download recurring invoice PDF
  /// Operation: GET /api/v1/recurring_invoice/{invitation_key}/download
  /// </summary>
  Task<Stream> DownloadAsync(string invitationKey, DownloadRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Add recurring invoice document
  /// Operation: POST /api/v1/recurring_invoices/{id}/upload
  /// </summary>
  Task<ApiResponse<RecurringInvoice>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadRecurringInvoiceRequest uploadRecurringInvoiceRequest, UploadRecurringInvoiceRequest? request = null, CancellationToken cancellationToken = default);
