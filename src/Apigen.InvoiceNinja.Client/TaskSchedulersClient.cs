...
/// </summary>
public partial class TaskSchedulersClient : ITaskSchedulersClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<TaskSchedulerSchema>> GetTaskSchedulersCreateAsync(GetTaskSchedulerRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<TaskSchedulerSchema>> BulkTaskSchedulerActionsAsync(List<int> body, BulkTaskSchedulerActionsRequest? request = null, CancellationToken cancellationToken = default)
  {
