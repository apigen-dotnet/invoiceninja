...
/// </summary>
public partial class ClaimLicenseClient : IClaimLicenseClient
{
  ...
  /// </summary>
  public async Task GetAsync(GetClaimLicenseRequest? request = null, CancellationToken cancellationToken = default)
  {
