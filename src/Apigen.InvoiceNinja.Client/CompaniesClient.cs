...
public partial class CompaniesClient : ICompaniesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Company>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadCompaniesRequest uploadCompaniesRequest, UploadCompaniesRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
