...
public partial class CompaniesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Company[]>> ListAsync(GetCompaniesRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Company>> CreateAsync(StoreCompanyRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "companies".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<Company>> GetCompaniesCreateAsync(GetCompaniesCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Company>> GetAsync(string id, ShowCompanyRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Company>> UpdateAsync(string id, UpdateCompanyRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeleteAsync(string id, DeleteCompanyRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Company>> EditCompanyAsync(string id, EditCompanyRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Company>> UploadCompaniesAsync(string id, Apigen.InvoiceNinja.Models.UploadCompaniesRequest uploadCompaniesRequest, UploadCompaniesRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Company>> SetDefaultCompanyAsync(string company, SetDefaultCompanyRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["company"] = company
  ...
  /// </summary>
  public async Task<ApiResponse<Company>> ShowCurrentCompanyAsync(ShowCurrentCompanyRequest? request = null, CancellationToken cancellationToken = default)
  {
