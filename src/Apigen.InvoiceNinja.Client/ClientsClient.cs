...
public partial class ClientsClient : IClientsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Apigen.InvoiceNinja.Models.Client>> EditAsync(string id, EditClientRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Apigen.InvoiceNinja.Models.Client>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadClientRequest uploadClientRequest, UploadClientRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task MergeAsync(string id, string mergeableClientHashedId, MergeClientRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<ApiResponse<Apigen.InvoiceNinja.Models.Client>> StatementAsync(Apigen.InvoiceNinja.Models.ClientStatementRequest clientStatementRequest, ClientStatementRequest? request = null, CancellationToken cancellationToken = default)
  {
