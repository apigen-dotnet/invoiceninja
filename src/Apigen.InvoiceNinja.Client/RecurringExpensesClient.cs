...
/// </summary>
public partial class RecurringExpensesClient : IRecurringExpensesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringExpense>> EditAsync(string id, EditRecurringExpenseRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringExpense>> BulkAsync(List<int> body, BulkRecurringExpensesRequest? request = null, CancellationToken cancellationToken = default)
  {
