...
/// </summary>
public partial class BankIntegrationsClient : IBankIntegrationsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<BankIntegration>> EditAsync(string id, EditBankIntegrationRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task BulkAsync(List<int> body, BulkBankIntegrationsRequest? request = null, CancellationToken cancellationToken = default)
  {
