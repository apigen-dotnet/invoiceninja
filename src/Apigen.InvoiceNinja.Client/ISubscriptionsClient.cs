...
public partial interface ISubscriptionsClient
{
  ...
  /// </summary>
  Task<ApiResponse<Subscription>> EditAsync(string id, EditSubscriptionRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Performs bulk actions on an array of subscriptions
  /// Operation: POST /api/v1/subscriptions/bulk
  /// </summary>
  Task<ApiResponse<Subscription>> BulkAsync(List<int> body, BulkSubscriptionsRequest? request = null, CancellationToken cancellationToken = default);
