...
/// </summary>
public partial class TaxRatesClient : ITaxRatesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<TaxRate>> EditAsync(string id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Webhook>> BulkAsync(List<int> body, BulkTaxRatesRequest? request = null, CancellationToken cancellationToken = default)
  {
