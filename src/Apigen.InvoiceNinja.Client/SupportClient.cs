...
/// </summary>
public partial class SupportClient : ISupportClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<JsonElement>> MessageAsync(Apigen.InvoiceNinja.Models.SupportMessageRequest supportMessageRequest, CancellationToken cancellationToken = default)
  {
