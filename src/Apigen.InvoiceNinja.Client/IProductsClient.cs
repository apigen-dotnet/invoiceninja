...
public partial interface IProductsClient
{
  ...
  /// </summary>
  Task<ApiResponse<Product>> EditAsync(string id, EditProductRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<ApiResponse<Product>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadProductRequest uploadProductRequest, UploadProductRequest? request = null, CancellationToken cancellationToken = default);
