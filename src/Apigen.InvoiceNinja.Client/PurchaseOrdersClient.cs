...
/// </summary>
public partial class PurchaseOrdersClient : IPurchaseOrdersClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder[]>> GetAsync(GetPurchaseOrdersRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> StoreAsync(Apigen.InvoiceNinja.Models.PurchaseOrderRequest purchaseOrderRequest, StorePurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "purchase_orders".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> ShowAsync(string id, ShowPurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> EditAsync(string id, EditPurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task BulkAsync(List<int> body, BulkPurchaseOrderssRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> ActionAsync(string id, string action, ActionPurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadPurchaseOrderRequest uploadPurchaseOrderRequest, UploadPurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<Stream> DownloadAsync(string invitationKey, DownloadPurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
