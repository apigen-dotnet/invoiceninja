...
public partial class PurchaseOrdersClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder[]>> GetPurchaseOrdersAsync(GetPurchaseOrdersRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> StorePurchaseOrderAsync(Apigen.InvoiceNinja.Models.PurchaseOrderRequest purchaseOrderRequest, StorePurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "purchase_orders".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> GetAsync(string id, ShowPurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> UpdateAsync(string id, Apigen.InvoiceNinja.Models.PurchaseOrderRequest purchaseOrderRequest, UpdatePurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeleteAsync(string id, DeletePurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> EditPurchaseOrderAsync(string id, EditPurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> GetPurchaseOrderCreateAsync(GetPurchaseOrderCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task BulkAsync(BulkPurchaseOrderssRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> GetAsync(string id, string action, ActionPurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<ApiResponse<PurchaseOrder>> UploadPurchaseOrderAsync(string id, Apigen.InvoiceNinja.Models.UploadPurchaseOrderRequest uploadPurchaseOrderRequest, UploadPurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<Stream> DownloadPurchaseOrderAsync(string invitationKey, DownloadPurchaseOrderRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
