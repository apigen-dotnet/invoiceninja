...
/// </summary>
public partial class CompanyGatewaysClient : ICompanyGatewaysClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<CompanyGateway>> EditAsync(string id, EditCompanyGatewayRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<CompanyGateway>> BulkAsync(List<int> body, BulkCompanyGatewaysRequest? request = null, CancellationToken cancellationToken = default)
  {
