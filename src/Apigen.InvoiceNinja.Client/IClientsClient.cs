...
public partial interface IClientsClient
{
  ...
  /// </summary>
  Task<ApiResponse<Apigen.InvoiceNinja.Models.Client>> EditAsync(string id, EditClientRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<ApiResponse<Apigen.InvoiceNinja.Models.Client>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadClientRequest uploadClientRequest, UploadClientRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task MergeAsync(string id, string mergeableClientHashedId, MergeClientRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Client statement PDF
  /// Operation: POST /api/v1/client_statement
  /// </summary>
  Task<ApiResponse<Apigen.InvoiceNinja.Models.Client>> StatementAsync(Apigen.InvoiceNinja.Models.ClientStatementRequest clientStatementRequest, ClientStatementRequest? request = null, CancellationToken cancellationToken = default);
