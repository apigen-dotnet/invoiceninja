...
public partial interface IBankIntegrationsClient
{
  ...
  /// </summary>
  Task<ApiResponse<BankIntegration>> EditAsync(string id, EditBankIntegrationRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task BulkAsync(List<int> body, BulkBankIntegrationsRequest? request = null, CancellationToken cancellationToken = default);
