...
/// </summary>
public partial class PaymentTermsClient : IPaymentTermsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<PaymentTerm>> EditAsync(string id, EditPaymentTermsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<PaymentTerm>> BulkAsync(List<int> body, BulkPaymentTermsRequest? request = null, CancellationToken cancellationToken = default)
  {
