...
public partial class QuotesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Quote[]>> ListAsync(GetQuotesRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Quote>> CreateAsync(Apigen.InvoiceNinja.Models.QuoteRequest quoteRequest, StoreQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "quotes".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<Quote>> GetAsync(string id, ShowQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Quote>> UpdateAsync(string id, Apigen.InvoiceNinja.Models.QuoteRequest quoteRequest, UpdateQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeleteAsync(string id, DeleteQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Quote>> EditQuoteAsync(string id, EditQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Quote>> GetQuotesCreateAsync(GetQuotesCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Quote>> BulkAsync(Apigen.InvoiceNinja.Models.BulkQuotesRequest bulkQuotesRequest, BulkQuotesRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Quote>> GetAsync(string id, string action, ActionQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<Stream> DownloadQuoteAsync(string invitationKey, DownloadQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
  ...
  /// </summary>
  public async Task<ApiResponse<Quote>> UploadQuoteAsync(string id, Apigen.InvoiceNinja.Models.UploadQuoteRequest uploadQuoteRequest, UploadQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<Stream> DownloadCreditAsync(string invitationKey, DownloadCreditRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["invitation_key"] = invitationKey
