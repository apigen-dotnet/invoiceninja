...
public partial class QuotesClient : IQuotesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Quote>> EditAsync(string id, EditQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Quote>> ActionAsync(string id, string action, ActionQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<Stream> DownloadAsync(string invitationKey, DownloadQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["invitation_key"] = invitationKey
  ...
  /// </summary>
  public async Task<ApiResponse<Quote>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadQuoteRequest uploadQuoteRequest, UploadQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
