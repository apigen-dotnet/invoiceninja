...
public partial class ProjectsClient : IProjectsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Project>> EditAsync(string id, EditProjectRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Project>> BulkAsync(List<int> body, BulkProjectsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Project>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadProjectRequest uploadProjectRequest, UploadProjectRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
