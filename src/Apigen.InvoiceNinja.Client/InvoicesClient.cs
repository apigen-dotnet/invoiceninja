...
public partial class InvoicesClient : IInvoicesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Invoice>> EditAsync(string id, EditInvoiceRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Invoice>> ActionAsync(string id, string action, ActionInvoiceRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
