...
/// </summary>
public partial class GroupSettingsClient : IGroupSettingsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<GroupSetting>> EditAsync(string id, EditGroupSettingRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task BulkAsync(List<int> body, BulkGroupSettingsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Invoice>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadGroupSettingRequest uploadGroupSettingRequest, UploadGroupSettingRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
