...
/// </summary>
public partial class BankTransactionsClient : IBankTransactionsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<BankTransaction>> EditAsync(string id, EditBankTransactionRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task BulkAsync(List<int> body, BulkBankTransactionsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task MatchAsync(List<int> body, MatchBankTransactionsRequest? request = null, CancellationToken cancellationToken = default)
  {
