...
public partial class MigrationClient
{
  ...
  /// </summary>
  public async Task PostPurgeCompanyAsync(string company, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task PostPurgeCompanySaveSettingsAsync(string company, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["company"] = company
  ...
  /// </summary>
  public async Task PostStartMigrationAsync(PostStartMigrationRequest? request = null, CancellationToken cancellationToken = default)
  {
