...
public partial interface IPaymentTermsClient
{
  ...
  /// </summary>
  Task<ApiResponse<PaymentTerm>> EditAsync(string id, EditPaymentTermsRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Performs bulk actions on an array of payment terms
  /// Operation: POST /api/v1/payment_terms/bulk
  /// </summary>
  Task<ApiResponse<PaymentTerm>> BulkAsync(List<int> body, BulkPaymentTermsRequest? request = null, CancellationToken cancellationToken = default);
