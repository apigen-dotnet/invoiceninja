...
public partial class LocationsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Location[]>> ListAsync(GetLocationsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Location>> CreateAsync(Apigen.InvoiceNinja.Models.LocationRequest locationRequest, StoreLocationRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "locations".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<Location>> GetAsync(string id, ShowLocationRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Location>> UpdateAsync(string id, Apigen.InvoiceNinja.Models.LocationRequest locationRequest, UpdateLocationRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Location>> GetLocationsCreateAsync(GetLocationsCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Location>> BulkAsync(Apigen.InvoiceNinja.Models.GenericBulkAction genericBulkAction, BulkLocationsRequest? request = null, CancellationToken cancellationToken = default)
  {
