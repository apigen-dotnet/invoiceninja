...
/// </summary>
public partial class RecurringQuotesClient : IRecurringQuotesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringQuote>> EditAsync(string id, EditRecurringQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringQuote>> BulkAsync(List<int> body, BulkRecurringQuotesRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<RecurringQuote>> ActionAsync(string id, string action, ActionRecurringQuoteRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
