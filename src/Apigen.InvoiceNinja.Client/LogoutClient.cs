...
public partial class LogoutClient
{
  ...
  internal LogoutClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task CreateAsync(GetLogoutRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "logout".BuildUrl(request: request);
