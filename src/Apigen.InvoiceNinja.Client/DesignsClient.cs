...
public partial class DesignsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Design[]>> ListAsync(GetDesignsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Design>> CreateAsync(StoreDesignRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "designs".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<Design>> GetAsync(string id, ShowDesignRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Design>> UpdateAsync(string id, UpdateDesignRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeleteAsync(string id, DeleteDesignRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Design>> EditDesignAsync(string id, EditDesignRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Design>> GetDesignsCreateAsync(GetDesignsCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Design>> BulkAsync(BulkDesignsRequest? request = null, CancellationToken cancellationToken = default)
  {
