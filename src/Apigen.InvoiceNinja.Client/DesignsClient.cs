...
/// </summary>
public partial class DesignsClient : IDesignsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Design>> EditAsync(string id, EditDesignRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Design>> BulkAsync(List<int> body, BulkDesignsRequest? request = null, CancellationToken cancellationToken = default)
  {
