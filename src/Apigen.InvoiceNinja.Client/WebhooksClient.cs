...
public partial class WebhooksClient : IWebhooksClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Webhook>> EditAsync(string id, EditWebhookRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Webhook>> BulkAsync(List<int> body, BulkWebhooksRequest? request = null, CancellationToken cancellationToken = default)
  {
