...
public partial interface IVendorsClient
{
  ...
  /// </summary>
  Task<ApiResponse<Vendor>> EditAsync(string id, EditVendorRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<ApiResponse<Vendor>> BulkAsync(List<int> body, BulkVendorsRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Uploads a vendor document
  /// Operation: POST /api/v1/vendors/{id}/upload
  /// </summary>
  Task<ApiResponse<Vendor>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadVendorRequest uploadVendorRequest, UploadVendorRequest? request = null, CancellationToken cancellationToken = default);
