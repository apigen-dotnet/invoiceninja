...
public partial interface IUsersClient
{
  ...
  /// </summary>
  Task<ApiResponse<User>> EditAsync(string id, EditUserRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Performs bulk actions on an array of users
  /// Operation: POST /api/v1/users/bulk
  /// </summary>
  Task<ApiResponse<User>> BulkAsync(List<int> body, BulkUsersRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Detach an existing user to a company
  /// Operation: DELETE /api/v1/users/{user}/detach_from_company
  /// </summary>
  Task DetachAsync(string user, DetachUserRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Reconfirm an existing user to a company
  /// Operation: POST /api/v1/users/{user}/invite
  /// </summary>
  Task InviteAsync(string user, InviteUserRequest? request = null, CancellationToken cancellationToken = default);
