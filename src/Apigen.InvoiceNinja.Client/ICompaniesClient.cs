...
public partial interface ICompaniesClient
{
  ...
  /// </summary>
  Task<ApiResponse<Company>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadCompaniesRequest uploadCompaniesRequest, UploadCompaniesRequest? request = null, CancellationToken cancellationToken = default);
