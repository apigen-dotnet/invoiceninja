...
public partial class TasksClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItem[]>> ListAsync(GetTasksRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItem>> CreateAsync(Apigen.InvoiceNinja.Models.TaskRequest taskRequest, StoreTaskRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "tasks".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItem>> GetAsync(string id, ShowTaskRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItem>> UpdateAsync(string id, Apigen.InvoiceNinja.Models.TaskRequest taskRequest, UpdateTaskRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeleteAsync(string id, DeleteTaskRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItem>> EditTaskAsync(string id, EditTaskRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItem>> GetTasksCreateAsync(GetTasksCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItem>> BulkAsync(BulkTasksRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItem>> UploadTaskAsync(string id, Apigen.InvoiceNinja.Models.UploadTaskRequest uploadTaskRequest, UploadTaskRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task SortTasksAsync(Apigen.InvoiceNinja.Models.TaskSortRequest taskSortRequest, SortTasksRequest? request = null, CancellationToken cancellationToken = default)
  {
