...
public partial class ProductsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Product[]>> ListAsync(GetProductsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Product>> CreateAsync(Apigen.InvoiceNinja.Models.ProductRequest productRequest, StoreProductRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "products".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<Product>> GetAsync(string id, ShowProductRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Product>> UpdateAsync(string id, Apigen.InvoiceNinja.Models.ProductRequest productRequest, UpdateProductRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeleteAsync(string id, DeleteProductRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Product>> EditProductAsync(string id, EditProductRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Product>> GetProductsCreateAsync(GetProductsCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Product>> BulkAsync(Apigen.InvoiceNinja.Models.ProductBulkAction productBulkAction, BulkProductsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Product>> UploadProductAsync(string id, Apigen.InvoiceNinja.Models.UploadProductRequest uploadProductRequest, UploadProductRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
