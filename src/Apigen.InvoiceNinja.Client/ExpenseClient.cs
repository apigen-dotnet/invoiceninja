...
public partial class ExpenseClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Expense>> UploadExpenseAsync(string id, Apigen.InvoiceNinja.Models.UploadExpenseRequest uploadExpenseRequest, UploadExpenseRequest? request = null, CancellationToken cancellationToken = default)
  {
