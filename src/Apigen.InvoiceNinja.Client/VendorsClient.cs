...
public partial class VendorsClient : IVendorsClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<Vendor>> EditAsync(string id, EditVendorRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<Vendor>> BulkAsync(List<int> body, BulkVendorsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<Vendor>> UploadAsync(string id, Apigen.InvoiceNinja.Models.UploadVendorRequest uploadVendorRequest, UploadVendorRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
