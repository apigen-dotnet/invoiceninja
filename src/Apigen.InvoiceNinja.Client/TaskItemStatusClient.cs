...
public partial class TaskItemStatusClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItemStatus>> StoreTaskStatusAsync(Apigen.InvoiceNinja.Models.TaskItemStatus taskItemStatus, StoreTaskStatusRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "task_statuses".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItemStatus>> GetAsync(string id, ShowTaskStatusRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItemStatus>> EditTaskStatussAsync(string id, EditTaskStatussRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<TaskItemStatus>> BulkAsync(BulkTaskStatussRequest? request = null, CancellationToken cancellationToken = default)
  {
