...
/// </summary>
public partial class BankTransactionRulesClient : IBankTransactionRulesClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<BankTransactionRule>> EditAsync(string id, EditBankTransactionRuleRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task BulkAsync(List<int> body, BulkBankTransactionRulesRequest? request = null, CancellationToken cancellationToken = default)
  {
