...
public partial interface IInvoicesClient
{
  ...
  /// </summary>
  Task<ApiResponse<Invoice>> EditAsync(string id, EditInvoiceRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<ApiResponse<Invoice>> ActionAsync(string id, string action, ActionInvoiceRequest? request = null, CancellationToken cancellationToken = default);
