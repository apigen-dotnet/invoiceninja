...
public partial class TokensClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<CompanyToken[]>> ListAsync(GetTokensRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<CompanyToken>> CreateAsync(StoreTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "tokens".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<ApiResponse<CompanyToken>> GetAsync(string id, ShowTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<CompanyToken>> UpdateAsync(string id, UpdateTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeleteAsync(string id, DeleteTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<CompanyToken>> EditTokenAsync(string id, EditTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<CompanyToken>> GetTokensCreateAsync(GetTokensCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ApiResponse<CompanyToken>> BulkAsync(BulkTokensRequest? request = null, CancellationToken cancellationToken = default)
  {
