...
public partial class TokensClient : ITokensClient
{
  ...
  /// </summary>
  public async Task<ApiResponse<CompanyToken>> EditAsync(string id, EditTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<ApiResponse<CompanyToken>> BulkAsync(List<int> body, BulkTokensRequest? request = null, CancellationToken cancellationToken = default)
  {
